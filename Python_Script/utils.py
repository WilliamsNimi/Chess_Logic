...
2/ King defended squares logic is inefficient. Should simply add all valid squares if the flag is set and return early rather than the current structure
"""
...
def pawn_threatened_squares(current_position, current_board, validity_check=False, include_defended_squares=False):
    ...
    if(validity_check):
      ...
      if(second_square_ahead_is_valid and first_square_ahead_is_valid and PAWN_HAS_NOT_MOVED and len(second_square_ahead_piece) == 0 and len(first_square_ahead_piece)==0):
